          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              body: proto.Message.InteractiveMessage.Body.create({
                text: `*_ᴇᴠɪʟ-ᴍᴅ ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ_*
╭────────────────────━┈⊷
│▸ 🔍 Download your favorite APKs.
│
│▸ 📌 Select APK from the below list.
╰────────────────────━┈⊷ `
              }),
    ...
    if (selectedAPK) {
      try {
        ...
        await Matrix.sendMessage(m.from, { image: { url: iconUrl }, caption: `╭────────────────────━┈⊷
│▸ You selected this APK:
